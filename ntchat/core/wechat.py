...
class ReqData:
    ...
    def wait_response(self, timeout=300000):
...
class WeChat:
    ...
    def on_recv(self, message):
        # if(message.data.room_wxid=="18462446628@chatroom"):
    ...
    def __send_sync(self, msg_type, data=None, timeout=300000):
    ...
    def send_text(self, to_wxid: str, content: str):
        ...
        return self.__send_sync(send_type.MT_SEND_TEXT_MSG, data)
